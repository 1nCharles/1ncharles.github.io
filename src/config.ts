...
export const siteConfig: SiteConfig = {
    ...
    banner: {
        ...
        credit: {
            ...
            text: "Miku", // Credit text to be displayed
...
export const navBarConfig: NavBarConfig = {
    links: [
        ...
        {
            name: "GitHub",
            url: "https://github.com/1nCharles", // Internal links should not include the base path, as it is automatically added
...
export const profileConfig: ProfileConfig = {
    ...
    links: [
        ...
        // },
        {
            ...
            url: "https://github.com/1nCharles",
        },
    ],
};
